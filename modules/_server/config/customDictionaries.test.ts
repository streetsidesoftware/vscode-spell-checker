...
import { CSpellUserSettings, CustomDictionaries, CustomDictionariesDictionary, DictionaryDefinition } from './cspellConfig';
import { extractDictionaryDefinitions } from './customDictionaries';
