...
const cspellUri = Uri.joinPath(Uri.parse(new URL('.', import.meta.url).toString()), 'cspell.json');
const dictUri = Uri.joinPath(Uri.parse(new URL('.', import.meta.url).toString()), 'words.txt');
const docUri = Uri.parse(import.meta.url);
