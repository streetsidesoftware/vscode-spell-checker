...
import { quickPickTarget } from './configTargetHelper.mjs';
import type { CSpellUserSettings } from './settings.base.mjs';
import { applyToConfig, normalizeLocale, orderTargetsLocalToGlobal, readConfigTargetValues } from './settings.base.mjs';
