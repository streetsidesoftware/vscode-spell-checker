...
export const CsTab = withStyles(createStyles({
    root: {
...
export const CsTabs = withStyles(createStyles({
    indicator: {
        'background': colors.colorSecondary,
    },
}))(Tabs);

export const CsAppBar = withStyles(createStyles({
    colorPrimary: {
        background: colors.tabBackground,
    }
}))(AppBar);
...
export const CsChip = withStyles((_theme) => createStyles({
    root: {
        color: colors.colorOnSecondary,
...
export const CsFormControl = withStyles(createStyles({
    root: {
        width: '100%',
        maxWidth,
    },
