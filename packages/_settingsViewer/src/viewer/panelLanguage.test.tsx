...
describe('Language Panel Verification', () => {
    it('checkboxLocalInfo', () => {
        ...
        const checkbox = create(checkboxLocalInfo(appState, appState.locals[0], 0, 'isInFolderSettings'));
        ...
        expect(appState.locals[0].isInFolderSettings).toBe(false);
        instance.props['onChange']({target: { checked: true, indeterminate: false }});
        expect(appState.locals[0].isInFolderSettings).toBe(true);
        instance.props['onChange']({target: { checked: true, indeterminate: true }});
        expect(appState.locals[0].isInFolderSettings).toBeUndefined();
    });
